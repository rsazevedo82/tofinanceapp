      ...
      {isLoading ? (
        ...
        <div className="py-16 text-center">
          ...
          <p className="text-xs mb-6" style={{ color: 'rgba(200,198,190,0.35)' }}>
            Adicione um cartao de credito em Contas
          </p>
          <button
...
function CardItem({ card, onClick }: { card: Account; onClick: () => void }) {
      ...
      {closedInvoice && (
        ...
        >
          <p className="text-xs" style={{ color: '#fb923c' }}>
            Fatura {closedInvoice.reference_month} fechada — aguardando pagamento
          </p>
